...
| 文档 | 路径 | 说明 |
|------|------|------|
| 付费墙与转化漏斗 | `docs/product/paywall-funnel.md` | 付费墙触发逻辑、埋点事件定义 |
| 扫描识别 & AI 评级 PRD | `docs/product/prd-scan-identify-grade.md` | 核心功能链路详细设计 |
| 数据流水线技术文档 | `docs/engineering/data-pipeline.md` | 爬虫架构、数据质量保障、使用方法 |
